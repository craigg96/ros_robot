...
Amended by shubhampaul:
https://create.arduino.cc/projecthub/30503/using-the-mpu9250-to-get-real-time-motion-data-08f011?ref=search&ref_id=mpu9250&offset=1
https://github.com/shubhampaul/Real_Time_Planet_Tracking_System/tree/master/MPU_fux_BNO_mBias


Amended by Craig Gault 28/10/2019 - Casta Spes Technologies, craig@castaspes.com 
- Uses pre estrablished calibration parameters to launch without calibration on startup 
- Added display and output frequency toggling
- Included PacketSerial to transfer IMU data to ROS
...
// Setting CalibrateMag to true will allow you to do figure of eights with the imu to normalise the magnetometer data.
// This will give 3 values for magbias[3] that can be hardcoded below
...
//  ASSIGN MAGNETOMETER BIAS' FROM CALIBRATION CYCLE

//    if (CalibrateMag == false){
//    magbias[0] = +9;  // User environmental x-axis correction in milliGauss
//    magbias[1] = +175;  // User environmental y-axis correction in milliGauss
//    magbias[2] = +191;  // User environmental z-axis correction in milliGauss
//    }
//9  175  191
...
if (output_ypr == true) {
 ...
 //Serial.print("Raw: "); Serial.print(ax); Serial.print(", "); Serial.print(ay); Serial.print(", "); Serial.print(az); Serial.print(", "); Serial.print(gx); Serial.print(", "); Serial.print(gy); Serial.print(", "); Serial.print(gz); Serial.print(", "); Serial.print(mx, 0); Serial.print(", "); Serial.print(my, 0); Serial.print(", "); Serial.println(mz, 0);

 

   // Serial.print("Yaw, Pitch, Roll: ");
    Serial.print(yaw - ypr_offset[0], 2);
    Serial.print(",");
    Serial.print(pitch - ypr_offset[1], 2);
    Serial.print(",");
    Serial.println(roll - ypr_offset[2], 2);
}
...
// Get hard iron correction
 ...
 Serial.println(" MAG BIAS X   Y   Z");
 Serial.print(mag_bias[0]); Serial.print("  "); 
 Serial.print(mag_bias[1]); Serial.print("  "); 
